...
\begin{itemize}
  ...
  \item We denote the cyclic group of order $n$ by $C_n$, and $C_n$ is identified with the additive group $\mathbf{Z}/n\mathbf{Z}$
  \item We denote the element of $C_n$ represented by $a \in \mathbf{Z}$ by $[a]$
\end{itemize}
